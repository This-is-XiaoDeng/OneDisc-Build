...
python -m nuitka --onefile --standalone --follow-imports --show-modules --output-dir=build --lto=yes main.py
...
git remote set-url origin https://x-access-token:$GH_TOKEN_1@github.com/This-is-XiaoDeng/OneDisc-Build.git
git pull
git push --force
